...
----
<1> full class-reference of a populated document collection
...
void testImportByMongoDataSetAnnotation() {
    ...
    Assertions.assertThat(fooDoc)
              ...
              .containsOnly(1, new Date(1516527720000L));
}
----
...
## Expecting database state after test execution
...
describe expected field as: `regex: ^[^@]+@[^@]+$`
